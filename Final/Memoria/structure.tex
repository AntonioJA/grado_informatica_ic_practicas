...
\newcommand{\changefont}{%
	\fontsize{3}{11}\sffamily
}
\newcommand{\setFooterL}[1]{
    \fancyfoot[L]{\changefont\small\textit{#1}}
}

\newcommand{\setFooterR}[1]{
    \fancyfoot[R]{\changefont\small\textit{#1}}
}
...
\draw[black,thick,dashed,opacity=.5,fill=white] (0,0) circle (9.9cm);
...
\node at (current page.north west)
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west] at (-4pt,4pt) {\includegraphics[width=\paperwidth,height=10.5cm]{\thechapterimage}};
